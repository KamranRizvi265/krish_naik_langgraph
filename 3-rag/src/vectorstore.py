...
class FaissVectorStore:
    ...
    def load(self):
        ...
        if os.path.exists(faiss_path) and os.path.exists(meta_path):
            ...
            print(f"[WARN] No FAISS index or metadata found in {self.persist_dir}. Please build the index first.")
    ...
    def query(self, query_text: str, top_k: int = 5):
        ...
        results = self.search(query_embedding.astype('float32'), top_k=top_k)
        return results